...
include::ProcessService.adoc[]

include::SupportBundleContents.adoc[]
...
include::DatastoreTypeProviders.adoc[]

include::GenericIntegrationPlugin.adoc[]

include::NetworkProviderPlugin.adoc[]

include::IPAMPlugins.adoc[]

include::ReportsPlugin.adoc[]

include::StorageDatastorePlugin.adoc[]
