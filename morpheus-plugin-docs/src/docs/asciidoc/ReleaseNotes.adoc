...
* **1.2.6**
** Added support for overriding views for Backup Providers.
** Added tab UI support for Backup Providers.
** Added ability for Backup Providers to add custom options to the restore backup prompt.
** Added context service support for StorageProviderType, NetworkSwitch, NetworkResourceGroup, NetworkResourceGroupMember
