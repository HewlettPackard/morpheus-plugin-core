...
public class HostVmGroup extends MorpheusIdentityModel {
	@JsonSerialize(using= ModelAsIdOnlySerializer.class)
	protected Account owner;
	protected String name;
	protected Boolean active = true;
	protected String visibility = "private";
	protected HostVmGroupType type = HostVmGroupType.HOST_GROUP;
	...
	public HostVmGroupType getType() {
		return type;
	}

	public void setType(HostVmGroupType type) {
		this.type = type;
	}
