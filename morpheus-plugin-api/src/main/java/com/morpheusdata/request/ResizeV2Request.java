...
public class ResizeV2Request {
	 ...
	 * <p>
	 * This use the UpdateModel to represent the morpheus pre-created entity, and the associated data for
	 * entity as provided by the user and morpheus.
	 */
	public List<UpdateModel<StorageVolume>> volumesAdd;
	 ...
	 * entity as provided by the user and morpheus.
	 */
	public List<UpdateModel<StorageController>> controllersAdd;
	 ...
	 * entity as provided by the user and morpheus.
	 */
	public List<UpdateModel<ComputeServerInterface>> interfacesAdd;
	...
	public ResizeV2Request(ServicePlan plan,
                           Long maxMemory, Long maxCores, Long maxStorage, Long coresPerSocket,
                           List<StorageVolume> volumesDelete, List<UpdateModel<StorageVolume>> volumesAdd, List<UpdateModel<StorageVolume>> volumesUpdate,
                           List<StorageController> controllersDelete, List<UpdateModel<StorageController>> controllersAdd, List<UpdateModel<StorageController>> controllersUpdate,
                           List<ComputeServerInterface> interfacesDelete, List<UpdateModel<ComputeServerInterface>> interfacesAdd, List<UpdateModel<ComputeServerInterface>> interfacesUpdate) {
		this.plan = plan;
