...
public interface MorpheusNetworkService extends MorpheusDataService<Network, NetworkIdentityProjection>, MorpheusIdentityService<NetworkIdentityProjection> {
	 ...
	 * @since 1.3.0
	 */
	Single<ServiceResponse<NetworkGroupPickResponse>> pickNextNetworkOrSubnetFromGroup(NetworkGroup group, Long accountId, Long siteId, Long zoneId, List<Network> usedNetworks, List<NetworkSubnet> usedSubnets, CloudPool cloudPool);
}
