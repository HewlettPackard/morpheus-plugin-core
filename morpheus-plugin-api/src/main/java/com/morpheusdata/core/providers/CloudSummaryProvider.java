 ...
 * <ul>
 *   <li>Display cloud-specific resource counts (e.g., VMware clusters, AWS EC2 instances)</li>
 *   <li>Show cloud service usage statistics</li>
 *   <li>Display custom cloud metadata or configuration details</li>
 * </ul>
 *
 * @author Saad Mansoor
 * @since 1.2.15
...
public interface CloudSummaryProvider extends UIExtensionProvider {
	...
	/**
	 * Renders the cloud summary content for the specified cloud.
	 * This method is called when the Cloud -> Summary tab is displayed.
	 *
	 * @param cloud the cloud for which to render the summary
	 ...
	 * @return HTMLResponse containing the rendered summary content
	 */
